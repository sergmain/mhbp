...
public class TimePeriods {
    ...
    private static boolean isActive(LocalTime curr, TimePeriod period) {
        return curr.equals(period.start) || curr.equals(period.end) || (curr.isAfter(period.start) && curr.isBefore(period.end));
    }
